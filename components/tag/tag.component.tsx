...
const variantStyle: VariantStyle = {
  small: "text-sm",
  medium: "rounded-lg px-2 ring-1 ring-inset",
};
...
type OperationColor = { [index: string]: string };

const operationColorMap: OperationColor = {
  get: "emerald",
  post: "sky",
  put: "amber",
  delete: "rose",
...
export function Tag({
  children,
  variant = "medium",
  color = operationColorMap[children.toLowerCase()] ?? "emerald",
}: {
  children: any;
  variant?: string;
  color?: string;
